...
public class ProductOrder
{
	...
	public ProductOrder(String orderNumber)
	{
	...
	public void setProductOptions(String productOptions) {this.productOptions = productOptions;}

	public void print()
	{
		System.out.printf("\nOrder # %3s Customer Id: %3s Product Id: %3s Product Name: %12s Options: %8s",
				orderNumber, customer.getId(), product.getId(), product.getName(), productOptions);// Printing the details
	}
	/*
	...
	public boolean equals(Object other)
	{
		...
		ProductOrder o1 = (ProductOrder) other;// object creation

		return orderNumber.equals(o1.getOrderNumber()); // returning if product order matches
	}
}
